...
.DESCRIPTION
    Runs clean-entities, clean-attributes, and clean-relationships in sequence.
...
$start = Get-Date
Write-Host "=== Dynamics 365 data clean — $(Get-Date -Format 'yyyy-MM-dd HH:mm') ===" -ForegroundColor Cyan
